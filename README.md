...
> 如需单应用，请移步 [visitor-fast](https://gitee.com/y_project/visitor-fast)  `(保持同步更新)`，如需其他版本，请移步 [项目扩展](http://doc.visitor.vip/#/standard/xmkz)  `(不定时更新)`
...
演示地址：http://visitor.vip  

文档地址：http://doc.visitor.vip
